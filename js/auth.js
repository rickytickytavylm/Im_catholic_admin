...
(function (global) {
  ...
  var ROLES = {
    super: {
      ...
      nav: ['dashboard', 'home', 'about', 'publish', 'news', 'articles', 'cycles', 'church', 'spirit', 'afisha', 'audio', 'video', 'church-day', 'materials', 'pages', 'taxonomy', 'authors', 'library', 'media', 'photographers', 'photo-moderation', 'users', 'logs', 'settings'],
      canPublish: true,
      canModerate: true,
      canManageUsers: true,
    ...
    chief: {
      ...
      nav: ['dashboard', 'home', 'about', 'publish', 'news', 'articles', 'cycles', 'church', 'spirit', 'afisha', 'audio', 'video', 'church-day', 'materials', 'pages', 'taxonomy', 'authors', 'library', 'media', 'photographers', 'photo-moderation', 'users', 'logs'],
      canPublish: true,
      canModerate: true,
  ...
  function canAccessNav(user, id) {
    ...
    if (id === 'publish' || id === 'home' || id === 'news' || id === 'articles' || id === 'cycles' || id === 'audio' || id === 'video' || id === 'afisha' || id === 'church-day' || id === 'authors' || id === 'church' || id === 'spirit') {
